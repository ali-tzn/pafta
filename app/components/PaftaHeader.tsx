...
const navigationGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      ["Cephe Kaplama Malzemeleri", "/yapi-malzemeleri/cephe-kaplama"],
  ...
  },
  {
    ...
    description: "Çizim, modelleme, render, parametrik tasarım ve BIM",
    icon: "UR",
    href: "/rehberler",
    matchPaths: ["/rehberler", "/revit", "/autocad", "/sketchup", "/rhino", "/grasshopper", "/photoshop", "/d5-render", "/dialux-evo", "/blender", "/bim"],
    items: [
      ...
      ["Grasshopper Rehberleri", "/grasshopper"],
      ["Photoshop Rehberleri", "/photoshop"],
      ["D5 Render Rehberleri", "/d5-render"],
      ["DIALux evo Rehberleri", "/dialux-evo"],
      ["Blender Rehberleri", "/blender"],
      ["BIM Merkezi", "/bim"],
    ],
  },
  {
