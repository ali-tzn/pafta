...
export const metadata: Metadata = { title: "Mimari Pafta Yerleşim Oluşturucu", description: "A0, A1 ve A2 mimari sunum paftaları için grid, kenar boşluğu, içerik sırası ve tipografi şeması oluştur.", alternates: { canonical: "/proje-araclari/pafta-yerlesimi" } };
