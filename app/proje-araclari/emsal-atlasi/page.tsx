...
export const metadata: Metadata = { title: "Mimari Emsal Proje Atlası", description: "Önemli mimari yapıları program, alan, dolaşım, taşıyıcı sistem ve tasarım stratejileri üzerinden incele ve karşılaştır.", alternates: { canonical: "/proje-araclari/emsal-atlasi" } };
