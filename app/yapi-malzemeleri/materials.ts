...
export const materialCategories: MaterialCategory[] = [
  ...
  {
    slug: "cephe-kaplama",
    name: "Cephe Kaplama Malzemeleri",
    description:
      "Havalandırmalı ve doğrudan uygulanan cephelerde kompozit panel, fibercement, HPL, terracotta, metal, taş ve porselen seçeneklerini karşılaştır.",
    icon: "▨",
  },
];
...
export const materials: Material[] = [
  ...
  {
    slug: "aluminyum-kompozit-panel", name: "Alüminyum Kompozit Panel", category: "cephe-kaplama",
    summary: "İki alüminyum levha arasındaki çekirdekten oluşan, hafif ve bükülebilir cephe paneli.",
    description: "Alüminyum kompozit panel; yüzey kaplaması, çekirdek sınıfı, kaset geometrisi ve alt konstrüksiyonuyla birlikte çalışan bir cephe ürünüdür. Yangın performansı yalnız görünen alüminyuma göre değil panel çekirdeği ve bütün cephe sistemi üzerinden değerlendirilmelidir.",
    uses: ["Havalandırmalı cephe", "Saçak ve parapet kaplaması", "Giriş kanopisi", "İç mekân duvar kaplaması"],
    advantages: ["Düşük ağırlık", "Kaset ve kıvrımlı form üretimi", "Geniş renk seçeneği", "Hızlı kuru montaj"],
    considerations: ["Çekirdek yangın sınıfı", "Rüzgâr yükünde kaset rijitliği", "Derz ve su tahliyesi", "Farklı metal temasında korozyon"],
    selectionNotes: ["FR/A2 çekirdek belgesini kullanım yerine göre doğrula", "Panel kalınlığını ve alt konstrüksiyonu statik hesapla seç", "Köşe, parapet ve pencere dönüşlerini sistem detayıyla çöz"],
    ratings: { thermal: 1, acoustic: 2, fire: 3, moisture: 5, lightness: 5, workability: 5, economy: 3 },
    keywords: ["alüminyum kompozit panel cephe", "kompozit cephe kaplama", "ACP panel özellikleri"],
  },
  {
    slug: "fibercement-levha", name: "Fibercement Levha", category: "cephe-kaplama",
    summary: "Çimento, selüloz lifleri ve mineral bileşenlerden üretilen dayanıklı levha kaplama.",
    description: "Fibercement levhalar, havalandırmalı cephelerde perçin, vida veya gizli bağlantıyla alt konstrüksiyona sabitlenir. Büyük ebatlı levhalarda derz, kenar mesafesi, genleşme ve rüzgâr yükü kararları ürün sistemine göre çözülür.",
    uses: ["Havalandırmalı cephe", "Saçak altı", "Balkon iç yüzeyi", "Prefabrike yapı kabuğu"],
    advantages: ["Mineral esaslı gövde", "Dış hava koşullarına uygun ürünler", "Farklı doku ve renk", "Kuru montaj"],
    considerations: ["Kesimde silika tozu", "Kenar ve delik mesafeleri", "Görünen bağlantı düzeni", "Levha hareketi"],
    selectionNotes: ["Dış cephe kullanım belgesini kontrol et", "Levha kalınlığını mesnet aralığıyla birlikte seç", "Kesilen kenarların koruma tarifini uygula"],
    ratings: { thermal: 1, acoustic: 3, fire: 5, moisture: 4, lightness: 3, workability: 3, economy: 3 },
    keywords: ["fibercement cephe", "fiber cement levha", "çimento esaslı cephe levhası"],
  },
  {
    slug: "hpl-kompakt-laminat", name: "HPL Kompakt Laminat", category: "cephe-kaplama",
    summary: "Yüksek basınç altında preslenen reçineli kraft katmanlarından oluşan renkli kompakt panel.",
    description: "Dış cephe tipi HPL paneller UV, nem ve sıcaklık değişimine uygun yüzeylerle üretilir. Panel boyutsal hareket gösterdiği için sabit ve hareketli bağlantı noktaları, delik çapları ve derzler üretici sistemine göre düzenlenir.",
    uses: ["Havalandırmalı cephe", "Balkon kaplaması", "Güneş kırıcı", "Giriş ve iç duvar"],
    advantages: ["Zengin renk ve desen", "İnce ve rijit panel", "Kolay temizlenen yüzey", "Kesilebilir modüler yapı"],
    considerations: ["Yangın sınıfı ürün tipine bağlıdır", "Isıl-nemsel hareket", "Kenar darbesi", "UV kalıcılığı"],
    selectionNotes: ["Dış cephe sınıfı ürünü seç", "Sabit/kayar nokta bağlantı şemasına uy", "Panel derzini ve arka havalandırmayı kesintisiz çöz"],
    ratings: { thermal: 1, acoustic: 2, fire: 2, moisture: 5, lightness: 4, workability: 4, economy: 3 },
    keywords: ["HPL cephe", "kompakt laminat dış cephe", "HPL panel özellikleri"],
  },
  {
    slug: "terracotta-panel", name: "Terracotta Cephe Paneli", category: "cephe-kaplama",
    summary: "Pişmiş kil esaslı, ray veya klipslerle taşınan modüler havalandırmalı cephe kaplaması.",
    description: "Terracotta paneller doğal kil gövdesi, renk kalıcılığı ve yatay modül karakteriyle kullanılır. Panel geometrisi, klips sistemi, rüzgâr emmesi ve kırılan parçanın güvenliği birlikte değerlendirilir.",
    uses: ["Havalandırmalı cephe", "Güneş kırıcı baguette", "Kamu ve eğitim yapıları", "Cephe yenileme"],
    advantages: ["Kalıcı doğal renk", "Yanmaz mineral gövde", "Havalandırmalı sistem uyumu", "Düşük bakım"],
    considerations: ["Kırılganlık ve darbe", "Modül kısıtları", "Yedek parça planı", "Alt konstrüksiyon maliyeti"],
    selectionNotes: ["Rüzgâr yükü ve panel açıklığını hesaplat", "Klips ve düşme emniyetini sistem olarak doğrula", "Köşe ve açıklık modüllerini tasarım başında çöz"],
    ratings: { thermal: 1, acoustic: 3, fire: 5, moisture: 5, lightness: 2, workability: 2, economy: 2 },
    keywords: ["terracotta cephe", "pişmiş toprak cephe paneli", "terracotta baguette"],
  },
  {
    slug: "dogal-tas-cephe", name: "Doğal Taş Cephe Kaplaması", category: "cephe-kaplama",
    summary: "Mermer, granit, traverten ve benzeri taşların mekanik ankraj veya panel sistemleriyle kullanımı.",
    description: "Doğal taş cephede taş türü, damar yönü, su emme, don dayanımı, panel boyutu ve ankraj bölgesindeki dayanım birlikte belirleyicidir. Taşın ticari adı tek başına güvenli kalınlık ve bağlantı seçimi için yeterli değildir.",
    uses: ["Mekanik ankrajlı cephe", "Soket ve giriş kaplaması", "Prekast taş paneller", "Cephe yenileme"],
    advantages: ["Doğal ve kalıcı görünüm", "Uygun taşta uzun servis ömrü", "Yüksek yangın dayanımı", "Farklı yüzey işlemleri"],
    considerations: ["Yüksek ağırlık", "Damar kaynaklı kırılma", "Ankraj ve deprem hesabı", "Lekelenme ve su hareketi"],
    selectionNotes: ["Taşa özgü test raporu iste", "Panel kalınlığını boyut ve ankrajla hesaplat", "Damlalık, derz ve arka su tahliyesini çöz"],
    ratings: { thermal: 1, acoustic: 4, fire: 5, moisture: 4, lightness: 1, workability: 2, economy: 2 },
    keywords: ["doğal taş cephe", "mekanik taş kaplama", "mermer cephe detayı"],
  },
  {
    slug: "gfrc-grc-panel", name: "GFRC / GRC Cephe Paneli", category: "cephe-kaplama",
    summary: "Cam elyaf takviyeli çimento harcıyla ince kesitli ve biçimlendirilebilir cephe elemanı.",
    description: "GFRC paneller ince kabuk, nervür veya çelik çerçeveli panel olarak üretilebilir. Panelin kendi ağırlığı, rüzgâr ve deprem etkileri; ankraj, taşıma, kaldırma ve derz hareketiyle birlikte projelendirilir.",
    uses: ["Prekast cephe paneli", "Üç boyutlu cephe", "Söve ve güneş kırıcı", "Yenileme kaplaması"],
    advantages: ["Karmaşık kalıp geometrileri", "Betona göre ince ve hafif kesit", "Mineral yüzey", "Fabrika üretimi"],
    considerations: ["Üretim toleransı", "Ankraj ve çerçeve korozyonu", "Renk farkı", "Nakliye ve kaldırma"],
    selectionNotes: ["Panel mühendislik hesabını üreticiden iste", "Mock-up ile yüzey ve derzi onayla", "Değiştirilebilir bağlantı ve erişim planla"],
    ratings: { thermal: 1, acoustic: 3, fire: 5, moisture: 4, lightness: 3, workability: 2, economy: 2 },
    keywords: ["GFRC cephe", "GRC panel", "cam elyaf takviyeli beton"],
  },
  {
    slug: "metal-cephe-paneli", name: "Metal Cephe Paneli", category: "cephe-kaplama",
    summary: "Alüminyum, galvaniz veya paslanmaz çelikten düz, trapez, perfore ya da kenetli üretilen kaplama.",
    description: "Metal cephe panellerinde alaşım ve kaplama, profil geometrisi, ısıl genleşme, rüzgâr yükü, yoğuşma ve farklı metal teması birlikte çözülür. Perfore paneller güneş kontrolü ve ikinci kabukta farklı açıklık oranları sunar.",
    uses: ["Endüstriyel ve ticari cephe", "Perfore ikinci kabuk", "Kenetli cephe", "Saçak ve parapet"],
    advantages: ["Hafif ve geri dönüştürülebilir", "Uzun boy ve farklı profil", "Hızlı montaj", "Perforasyon seçenekleri"],
    considerations: ["Isıl genleşme", "Yağmur ve darbe sesi", "Korozyon", "Yüzeyde dalgalanma"],
    selectionNotes: ["Alaşım ve boya sistemini çevre koşuluna göre seç", "Sabit/kayar bağlantıları hesapla", "Yoğuşma ve akustik alt katmanları çöz"],
    ratings: { thermal: 1, acoustic: 1, fire: 5, moisture: 5, lightness: 5, workability: 4, economy: 3 },
    keywords: ["metal cephe paneli", "perfore cephe", "kenetli metal cephe"],
  },
  {
    slug: "porselen-cephe-paneli", name: "Porselen Cephe Paneli", category: "cephe-kaplama",
    summary: "Düşük su emmeli, büyük ebatlı seramik plakaların mekanik veya karma sistemle cephede kullanımı.",
    description: "Büyük ebat porselen plakalar düşük su emme ve yüzey çeşitliliği sunar. İnce plakalarda ağ desteği, kesim, delik ve kenar davranışı; mekanik güvenlik ve yapıştırıcı seçimiyle birlikte ele alınır.",
    uses: ["Havalandırmalı cephe", "Giriş kaplaması", "İç-dış süreklilik", "Cephe yenileme"],
    advantages: ["Düşük su emme", "UV ve leke direnci", "Geniş desen", "İnce panel seçenekleri"],
    considerations: ["Kırılgan kenarlar", "Büyük ebat taşıma", "Gizli bağlantı hassasiyeti", "Alt yüzey toleransı"],
    selectionNotes: ["Dış cephe ve mekanik bağlantı onayını doğrula", "Panel boyutunu rüzgâr hesabıyla seç", "Köşe, derz ve yedek panel planını hazırla"],
    ratings: { thermal: 1, acoustic: 2, fire: 5, moisture: 5, lightness: 3, workability: 2, economy: 2 },
    keywords: ["porselen cephe", "büyük ebat seramik cephe", "sinterlenmiş yüzey cephe"],
  },
];
