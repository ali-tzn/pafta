...
export const metadata: Metadata = { title: "Mimari Yönetmelik Kontrol Asistanı", description: "Yapı türü, alan ve kat sayısına göre imar, yangın, erişilebilirlik, otopark ve dolaşım kontrol başlıklarını oluştur.", alternates: { canonical: "/proje-araclari/yonetmelik-kontrol" } };
